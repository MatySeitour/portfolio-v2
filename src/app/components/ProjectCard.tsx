    ...
    >
      ...
      >
        <div className="flex h-full w-full flex-col overflow-hidden">
          ...
          ></Image>
          <motion.div className="relative flex h-full flex-col justify-center gap-4 overflow-hidden rounded-b-md bg-[#111a] p-4">
            ...
            <div className="flex justify-between">
              <ul className="relative z-10 flex h-auto w-full max-w-full flex-wrap items-center justify-start gap-2 sm:max-w-md">
